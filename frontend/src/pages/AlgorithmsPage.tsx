        ...
        <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {visibleAlgorithms.map((algorithm) => (
            <StaggerItem key={algorithm.id}>
              <article
                className="panel flex flex-col p-8 border-emerald-950/80 bg-black hover:border-emerald-500/50 hover:shadow-[0_0_30px_rgba(16,185,129,0.15)] transition-all hover:scale-[1.02] duration-300"
              >
