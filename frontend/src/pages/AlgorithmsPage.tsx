  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 bg-black">
      <div className="max-w-2xl">
        ...
        <h1 className="mt-3 text-4xl font-black tracking-tight text-white">Algorithms you can actually follow.</h1>
      ...
      <div className="mt-9 flex flex-col gap-4 rounded-2xl border border-emerald-950/80 bg-zinc-950/80 p-4 sm:flex-row sm:items-center sm:justify-between shadow-[0_0_30px_rgba(0,0,0,0.8)]">
        ...
        <label className="relative block sm:w-72">
          ...
          <input
            ...
            className="w-full rounded-xl border border-emerald-950 bg-black py-2 pl-10 pr-3.5 text-sm text-white placeholder:text-zinc-600 focus:border-emerald-500 focus:outline-none"
          />
        </label>
      </div>
      ...
      <div className="mt-7 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {visibleAlgorithms.map((algorithm) => (
          ...
          >
            ...
            <h2 className="mt-5 text-xl font-bold text-white">{algorithm.name}</h2>
            <p className="mt-2 flex-1 text-sm leading-6 text-zinc-400">{algorithm.shortDescription}</p>
            <div className="mt-6 flex items-center justify-between border-t border-emerald-950 pt-4 text-sm">
      ...
      {visibleAlgorithms.length === 0 && (
        <div className="panel mt-7 p-10 text-center border-emerald-950 bg-black">
